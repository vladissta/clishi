#' Оценка вероятности ошибки I рода для критерия Манна-Уитни при различных распределениях и их параметрах
#'
#' Функция проводит симуляцию для оценки вероятности ошибки I рода
#' непараметрического критерия Манна-Уитни-Уилкоксона при различных параметрах
...
#'
#' @details
#' Функция создает симулированные данные для двух групп, применяет критерий
#' Манна-Уитни-Уилкоксона для каждой симуляции и вычисляет долю случаев,
...
#' mann_whitney(distribution = "normal", 
#'              mu1 = 20, sigma1 = 2, 
#'              mu2 = 20, sigma2 = 2)
#'
#' # Оценка вероятности ошибки I рода для экспоненциального распределения
#' mann_whitney(distribution = "exponential", 
#'              mu1 = 20, 
#'              mu2 = 25, 
#'              sample_size = 50, 
#'              n_sim = 2000)
